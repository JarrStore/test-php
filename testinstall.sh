...
MYSQL_SCRIPT
    ...
    2)
        ...
        echo "Izin dan konfigurasi diatur."
...
EOL
        ...
        echo "Konfigurasi Nginx diatur untuk phpMyAdmin."

        # Mengaktifkan situs dan restart Nginx
        ln -s /etc/nginx/sites-available/phpmyadmin.conf /etc/nginx/sites-enabled/phpmyadmin.conf
        systemctl restart nginx

        echo "phpMyAdmin selesai diatur. Anda dapat mengaksesnya di https://${DOMAIN}"
        ;;
